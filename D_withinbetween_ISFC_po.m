...
dirs.fMRI = '../../data/processed_data/Posi_voxel_processed';   % 
dirs.mat = '../../data/transformed_mat/positive12dofsm4_3mm_t';   %
...
dirs.roi = '../../T_RESULTS/betweengroup/positiveresult/ISC_maskforISFC/'; 
dirs.roi_tc = '../../data/transformed_mat/positive12dofsm4_3mm_t/roi_tc/';
...
%% ISFC analysis
dirs.result = '../../T_RESULTS/betweengroup/positiveresult/ISFC/';
...
save(fullfile(dirs.result,sprintf('WithinBetweenISFC_po.mat')),'ROI_pair','All_within_ISFC','All_between_ISFC','All_withinbetween_ISFC');
csvwrite(fullfile(dirs.result, 'All_within_ISFC_ROIwise_po.csv'),All_within_ISFC);
csvwrite(fullfile(dirs.result, 'All_between_ISFC_ROIwise_po.csv'),All_between_ISFC);
csvwrite(fullfile(dirs.result, 'All_withinbetween_ISFC_ROIwise_po.csv'),All_withinbetween_ISFC);
