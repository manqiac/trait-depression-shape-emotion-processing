...
dirs.tlrc = '../../data/transformed_mat/negative12dofsm4_3mm_t/tlrc_t/';
dirs.negativeresult = '../../T_RESULTS/betweengroup/negativeresult/ISC';
savepath = fullfile(dirs.negativeresult);
...
save(fullfile(dirs.negativeresult, 'WithinBetweenISC_nega.mat'),'sub','WithinISC','BetweenISC','WithinBetweenISC');

%% Shuffle stats 
load(fullfile(dirs.negativeresult,'WithinBetweenISC_nega.mat'));
...
for iteration = 1:10000
    ...
    save(fullfile(dirs.negativeresult,sprintf('WithinBetweenISC_flip10000_nega.mat')),'true_mean','permutation_p','r_count','iteration');
    

%% Save map 
load(fullfile(dirs.negativeresult,'WithinBetweenISC_flip10000_nega.mat'));
...
save_nii(nii,fullfile(dirs.negativeresult,'WithinBetweenISC_R_Nocorrection.nii'));
...
save_nii(nii, fullfile(dirs.negativeresult,'WithinBetweenISC_R_fdr0002.nii'));
...
save_nii(nii,fullfile(dirs.negativeresult,'WithinBetweenISC_Z_fdr0002.nii'));
...
save_nii(nii, fullfile(dirs.negativeresult,'WithinBetweenISC_R_fdr0001.nii'));
...
save_nii(nii,fullfile(dirs.negativeresult,'WithinBetweenISC_Z_fdr0001.nii'));
