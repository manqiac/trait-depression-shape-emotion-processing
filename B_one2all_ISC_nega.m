...
save(fullfile(dirs.negativeresult, 'One2allother_ISC_nega.mat'),'sub_id','All_To_other_ISC','Ave_one2allother_ISC');

%% Shuffle stats 
load(fullfile(dirs.negativeresult,'One2allother_ISC_nega.mat'));
...
save(fullfile(dirs.negativeresult,'One2allother_ISC_nega_flip10000.mat'),'true_mean','r_count','iteration','p_permutation');  

%% Save avg_one2allother map 
load(fullfile(dirs.negativeresult,'One2allother_ISC_nega_flip10000.mat'));
...
save_nii(nii, fullfile(dirs.negativeresult,'Avg_one2allother_Nocorrection.nii'));
...
save_nii(nii, fullfile(dirs.negativeresult,'Avg_one2allother_fdr0002.nii'));
...
save_nii(nii, fullfile(dirs.negativeresult,'Avg_one2allother_fdr0001.nii'));
